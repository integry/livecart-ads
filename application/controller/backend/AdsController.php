 ...
 */
class AdsController extends StoreManagementController
{
	...
	{
		$advertisers = ActiveRecordModel::getRecordSetArray('AdAdvertiser', select());

		$response = new ActionResponse();
		$response->set('advertisers', $advertisers);
		return $response;
	}
